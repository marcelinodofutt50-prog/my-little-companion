...
- Testes de abuso: INSERT direto com R$ 0,01, alteração de `amount`, checkout com pedido adulterado, webhook subpago, moeda errada e reutilização de pagamento — todos devem falhar sem entrega.
