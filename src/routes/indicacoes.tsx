                        ...
                        <div className="rounded border border-primary/10 bg-primary/5 p-3 flex flex-col gap-2">
                          ...
                          <div className="flex items-center gap-2">
                            <code className="flex-1 text-[10px] truncate bg-black/40 p-2 rounded border border-white/5 text-primary">
                              {window.location.origin.includes('lovable') || window.location.origin.includes('localhost') ? 'https://www.shadowdashstore.com' : window.location.origin}/auth?ref={data.code}
                            </code>
                            <Button 
                              size="sm" 
                              variant="ghost" 
                              className="h-8 px-2"
                              onClick={() => {
                                const base = window.location.origin.includes('lovable') || window.location.origin.includes('localhost') ? 'https://www.shadowdashstore.com' : window.location.origin;
