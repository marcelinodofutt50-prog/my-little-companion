      ...
      if (error) {
        ...
        if (isSchemaError && attempt <= 3) {
          ...
          try {
            ...
            console.warn(`[tutorial_progress] [${timestamp}] RPC de refresh falhou:`, rpcError);
          }
          await new Promise((r) => setTimeout(r, 1000 * attempt));
          return fetchWithRetry(attempt + 1);
        }

        console.warn(`[tutorial_progress] [${timestamp}] Falha persistente. Retornando progresso vazio.`);
        return [];
      }
