  ...
  const rows = [
    {
      ...
      before: t("ba.metric.setup.before"),
      after: t("ba.metric.setup.after"),
      lift: "-99%",
    },
    {
      icon: ShieldAlert,
      metric: t("ba.metric.risk"),
      before: t("ba.metric.risk.before"),
      after: t("ba.metric.risk.after"),
      lift: "0 falhas",
    },
    {
      icon: Target,
      metric: t("ba.metric.success"),
      before: t("ba.metric.success.before"),
      after: t("ba.metric.success.after"),
      lift: "+180%",
    },
    {
      icon: Zap,
      metric: t("ba.metric.support"),
      before: t("ba.metric.support.before"),
      after: t("ba.metric.support.after"),
      lift: "24/7",
    },
    {
      icon: DollarSign,
      metric: t("ba.metric.cost"),
      before: t("ba.metric.cost.before"),
      after: t("ba.metric.cost.after"),
      lift: "-75%",
    },
  ];
