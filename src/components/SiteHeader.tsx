...
import shadowMarkAsset from "@/assets/shadow-mark-v8.png.asset.json";
    ...
    <header className="sticky top-0 z-50 hairline-b bg-background/85 backdrop-blur-xl">
      <div className="mx-auto flex h-14 max-w-6xl items-center gap-4 px-4 sm:px-6">
        ...
        <Link to="/" className="flex shrink-0 items-center gap-2 transition-opacity hover:opacity-70">
          <img src={shadowMark} alt="" width={32} height={32} decoding="async" className="block h-7 w-7 shrink-0 object-contain sm:h-8 sm:w-8 drop-shadow-[0_0_8px_rgba(201,168,76,0.6)] brightness-110 dark:brightness-125 dark:contrast-125 light:mix-blend-multiply" />
              ...
              <div className="flex h-full flex-col">
                <div className="hairline-b px-6 py-5">
                  <div className="flex items-center gap-2">
                    <img src={shadowMark} alt="" width={32} height={32} loading="lazy" decoding="async" className="block h-7 w-7 shrink-0 object-contain brightness-110 dark:brightness-125 dark:contrast-125 light:mix-blend-multiply" />
