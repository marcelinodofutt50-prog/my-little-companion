...
-- 5. Bucket de Avatares
-- Nota: O bucket é gerenciado via storage API, mas garantimos permissão aqui se possível
-- Ou via dashboard, mas aqui reforçamos o recarregamento do cache.
